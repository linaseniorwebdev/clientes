...
function getLocation() {
	...
	GMaps.geolocate({
		...
		error: function(t) {
			swal("Geolocalización fallida", "", "warning");
			preloader.fadeOut("fast");
		},
		not_supported: function() {
			swal("", "Parece que su navegador no soporta la geolocalización o prohibir. Por favor, asegúrese de que esté habilitado y vuelva a intentarlo.", "warning");
			preloader.fadeOut("fast");
		},
		always: function() {}
	});
